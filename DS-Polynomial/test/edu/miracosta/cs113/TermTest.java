...
public class TermTest {
    ...
    public void testStringConstructor() {
        ...
        for(int i = 1; i < TERMS.length; i++) {
            ...
            assertEquals("Expected and actual coefficients DON'T match for " + t, c, test.getCoefficient());
            assertEquals("Expected and actual exponents DON'T match for " + t , e, test.getExponent());
        }
    }
